        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Image.network('https://cdn-icons-png.flaticon.com/512/3135/3135715.png',height: 50,width: 50,),
                  Padding(
                            ...
                            if(user == 'learner')
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Center(
                                    child: Text('Learner',style: TextStyle( color: Color(0xffffffff),fontSize: 17),),
                                  ),
                                ),
                              ),
